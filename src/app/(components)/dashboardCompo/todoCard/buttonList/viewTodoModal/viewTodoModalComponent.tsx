...
export default function ViewTodoModal({todoItem}:TodoCardProps){
                    ...
                    <div className="modal-box w-11/12 max-w-5xl h-5/6">
                        ...
                        <form >
                            <div className="mb-5">
                                ...
                                <input type="text" id="title" value={todoItem.title} className=" shadow-md
                            ...
                            <div>
                                ...
                                <textarea id="descriptions" value={todoItem.descriptions} rows={10} className=" shadow-md block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Details..." disabled></textarea>
                            </div>
                            <div>
                                <label htmlFor="date" className="block mt-2 mb-2 text-sm font-medium text-gray-900 dark:text-white">Due Date</label>
                                <input type="date" id="date" value={todoItem.due_date } className="shadow-md block p-2 text-gray-900 border border-gray-300 rounded-lg 
